...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s spiffcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  spiffcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded spiffcoin transaction") + "\n" +
              "  spiffcoin-tx [options] -create [commands]   " + _("Create hex-encoded spiffcoin transaction") + "\n" +
              "\n";
