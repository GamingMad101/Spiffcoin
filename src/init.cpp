...
void Shutdown()
{
    ...
    RenameThread("spiffcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // spiffcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/spiffcoin/spiffcoin>";
    const std::string URL_WEBSITE = "<https://spiffcoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("spiffcoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // spiffcoin: Do we need to do any RPC mining init here?
