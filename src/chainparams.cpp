...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in spiffcoin v2 blocks, so we enforce from v3
        ...
        // consensus.BIP65Height = 1032483; // Not enabled in spiff yet
        ...
        // XXX: BIP heights and hashes all need to be updated to spiffcoin values
        ...
        vSeeds.push_back(CDNSSeedData("multispiff.org", "seed.multispiff.org", true));
        vSeeds.push_back(CDNSSeedData("multispiff.org", "seed2.multispiff.org"));
        ...
        //TODO: fix this for spiffcoin -- plddr
