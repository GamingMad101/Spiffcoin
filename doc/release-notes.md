spiffcoin Core version 1.14.2 is now available from:

  <https://github.com/spiffcoin/spiffcoin/releases/tag/v1.14.0/>
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/spiffcoin/
  * @spiffcoin on Twitter for high priority announcements
  * @spiffcoin\_devs on Twitter for updates on development work
...
spiffcoin Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
spiffcoin Core should also work on most other Unix-like systems but is not
...
spiffcoin Core introduces pruning the blockchain in 1.14. Pruning
...
When spiffcoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in spiffcoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of spiffcoin Core. This was added in conjunction with
